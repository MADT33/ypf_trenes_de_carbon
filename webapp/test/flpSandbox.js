		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "tk Carga Trenes Carbon",
									"targetURL": "#ypftkcargatrenescarbon-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ypftkcargatrenescarbon-display": {
								"semanticObject": "ypftkcargatrenescarbon",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ypf.tkcargatrenescarbon",
									"url": sap.ui.require.toUrl("ypf/tkcargatrenescarbon")
								}
							}
						}
					}
